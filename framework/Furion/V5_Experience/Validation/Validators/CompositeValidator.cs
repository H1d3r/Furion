...
public class CompositeValidator<T> : ValidatorBase<T>, IValidatorInitializer, IDisposable
{
    ...
    /// <param name="ruleMode"><see cref="Furion.Validation.RuleMode" />，默认值为：<see cref="RuleMode.FailFast" /></param>
    ...
    /// </summary>
    /// <remarks>默认值为：<see cref="Furion.Validation.RuleMode.FailFast" />。</remarks>
