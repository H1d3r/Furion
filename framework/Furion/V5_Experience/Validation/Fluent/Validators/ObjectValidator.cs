    ...
    IValidationAttributeConfigurable
{
    ...
    /// <summary>
    ///     <inheritdoc cref="Furion.Validation.RuleMode" />
    /// </summary>
    /// <remarks>默认值为：<see cref="Furion.Validation.RuleMode.All" />。</remarks>
    public RuleMode RuleMode { get; set; } = RuleMode.All;

    /// <summary>
    ///     <inheritdoc cref="CascadeMode" />
    /// </summary>
    /// <remarks>默认值为：<see cref="Furion.Validation.CascadeMode.All" /></remarks>
    ...
    /// </summary>
    /// <param name="ruleMode">
    ///     <see cref="Furion.Validation.RuleMode" />
    /// </param>
    /// <returns>
    ///     <see cref="ObjectValidator{T}" />
    /// </returns>
    ...
    ///     <see cref="Furion.Validation.CascadeMode" />
    /// </param>
    /// <returns>
    ///     <see cref="ObjectValidator{T}" />
    /// </returns>
